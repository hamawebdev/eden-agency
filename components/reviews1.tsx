...
const DEFAULT_REVIEWS: Review[] = [
  ...
  },
  {
    id: "2",
    rating: 5,
    content: "انا بطبيعتي ديما انسان مانديرش الثقة فيمن جا . بصح eden يخلوك تثيق فيهم بالسيف من المعاملة تاعهم الطيبة و سرعة الرد و الضمانات و كلش . هاذي مش اول مرة نتعامل معاهم و باذن الله مش الاخير و راح نرشحهم لكل واحد يحوس على الخدمات لي يقدموهم . بالتوفيق",
    author: {
      name: "Sif Eddine",
    },
    date: "27/06/2025",
